...
Action.create(name: 'earn_tree', count: 345, user: user4)
...
Action.create(name: 'earn_tree', count: 50, user: user5)
...
Action.create(name: 'earn_tree', count: 605, user: user7)
...
Action.create(name: 'earn_tree', count: 231, user: user8)
