...
pig_driver = Badge.new(name: 'Pig Driver', description: 'You are driving a dirty car. I know, not everyone can afford to change to a newer one or going without one, so just keep in mind for the future and try your best with the challenges!', icon_url: '017-ecology-and-environment.svg', trigger: 'add_car', countable: 'count', threshold: 1)
