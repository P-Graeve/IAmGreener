...
tree_lord1 = Badge.new(name: 'Lord of the Trees', description: 'You did a lot of challenges and earned those trees!', icon_url: '004-joshua-tree.svg', trigger: 'complete_challenge', countable: 'count' , threshold: 2, stars: 1)
tree_lord2 = Badge.new(name: 'Lord of the Trees', description: 'You did a lot of challenges and earned those trees!', icon_url: '004-joshua-tree.svg', trigger: 'complete_challenge', countable: 'count', threshold: 5, stars: 2)
tree_lord3 = Badge.new(name: 'Lord of the Trees', description: 'You did a lot of challenges and earned those trees!', icon_url: '004-joshua-tree.svg', trigger: 'complete_challenge', countable: 'count' , threshold: 10, stars: 3)
